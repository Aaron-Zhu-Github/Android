...
import com.picture.util.Util;

import static com.picture.view.viewpager.JazzyViewPager.sOutlineColor;
...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setColor(getResources().getColor(R.color.holo_blue, null));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mOutlinePaint.getColor() != sOutlineColor) {
            mOutlinePaint.setColor(sOutlineColor);
        }
